...
def playback_thread() -> None:
    """Drains play_buffer and writes Int16 PCM to sounddevice output."""
    global active_stream, last_play_time
...
async def main() -> None:
    ...
    async with aiohttp.ClientSession() as session:
        try:
            ...
            emit({
                "type": "error",
                "message": f"Cannot connect to voice server at {WS_URL}. Is web_app.py running?"
            })
