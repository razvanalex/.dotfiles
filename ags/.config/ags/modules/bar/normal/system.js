...
const Utilities = () => Box({
    ...
    children: [
        UtilButton({
            name: 'Screenshot region', icon: 'screenshot_region', onClicked: () => {
                Utils.execAsync(`${App.configDir}/scripts/grimblast.sh copy area`)
                    .catch(print)
            }
        }),
        UtilButton({
            name: 'Screenshot monitor', icon: 'screenshot_monitor', onClicked: () => {
                Utils.execAsync(`${App.configDir}/scripts/grimblast.sh copy screen`)
                    .catch(print)
            }
        }),
        UtilButton({
            name: 'Screenshot widow', icon: 'capture', onClicked: () => {
                // Utils.execAsync(`${App.configDir}/scripts/grimblast.sh copy area`)
                //     .catch(print)
            }
        }),
