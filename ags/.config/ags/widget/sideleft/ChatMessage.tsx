			...
			switch (block.type) {
				...
				case "list":
					return (
						...
						>
							{(() => {
								return (block.items || []).map((item: string, _i: number) => (
									<box
						...
						>
							...
							{message.isIncomplete && (
								<box
									...
									spacing={3}
								>
									<label class="icon-material txt-small" label="schedule" />
									<label
										class="txt txt-smallie txt-subtext"
							...
							{blocks.length > 0 ? (
								...
								<label class="txt txt-smallie" label={message.content} wrap />
							)}
						</box>
					);
				})()}
