        ...
        >
            <box>
                <box
                    class={animated.as(
                        (a) =>
                            `sidebar-todo-item spacing-h-5 ${a ? "sidebar-todo-crosser-crossed" : ""}`,
                    )}
                >
                    <box orientation={Gtk.Orientation.VERTICAL} hexpand>
                        ...
                        />
                        <box
                            class="spacing-h-5 sidebar-todo-actions"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <For
                            each={todos.as((allTodos: TodoItem[]) =>
                                allTodos
                                    .map((todo, i) => ({
                                        ...todo,
                                        originalIndex: i,
        ...
        <box orientation={Gtk.Orientation.VERTICAL} class="spacing-v-5" vexpand>
            <box halign={Gtk.Align.CENTER} class="sidebar-icontabswitcher">
                <button
                    class={activeTab.as(
                        (t) =>
                            `sidebar-iconbutton ${t === 0 ? "sidebar-button-active" : ""}`,
                    )}
                ...
                <button
                    class={activeTab.as(
                        (t) =>
                            `sidebar-iconbutton ${t === 1 ? "sidebar-button-active" : ""}`,
                    )}
