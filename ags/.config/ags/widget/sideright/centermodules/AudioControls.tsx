                ...
                <box orientation={Gtk.Orientation.VERTICAL}>
                    ...
                    >
                        <For each={devices}>
                            {(device) => {
                                const hasIcon =
                                    device.icon && iconExists(device.icon);
