        ...
        >
            <box class="spacing-h-10">
                <label
                    ...
                    label={
                        SIGNAL_STRENGTH_ICONS[accessPoint.iconName] ||
                        "signal_wifi_0_bar"
                    }
                />
                ...
                >
                    ...
                    >
                        <box class="spacing-h-10">
                            ...
                            <box orientation={Gtk.Orientation.VERTICAL} hexpand>
                                <label
                                    ...
                                    class="txt-smaller txt-subtext"
                                    label="Current network"
                                />
                                <label
                                    halign={Gtk.Align.START}
                                    label={ssid.as((s) => s || "Not connected")}
                                />
                            </box>
                            <label
                                ...
                                label={state.as((s) => {
                                    ...
                                    if (
                                        ...
                                        s === Network.DeviceState.NEED_AUTH
                                    ) {
                                    ...
                                    const stateMap: Record<number, string> = {
                                        [Network.DeviceState.UNKNOWN]:
                                            "Unknown",
                                        [Network.DeviceState.UNMANAGED]:
                                            "Unmanaged",
                                        [Network.DeviceState.UNAVAILABLE]:
                                            "Unavailable",
                                        [Network.DeviceState.DISCONNECTED]:
                                            "Disconnected",
                                        [Network.DeviceState.PREPARE]:
                                            "Preparing...",
                                        [Network.DeviceState.CONFIG]:
                                            "Configuring...",
                                        [Network.DeviceState.NEED_AUTH]:
                                            "Authenticating...",
                                        [Network.DeviceState.IP_CONFIG]:
                                            "Getting IP...",
                                        [Network.DeviceState.IP_CHECK]:
                                            "Checking IP...",
                                        [Network.DeviceState.SECONDARIES]:
                                            "Secondaries...",
                                        [Network.DeviceState.ACTIVATED]:
                                            "Connected",
                                        [Network.DeviceState.DEACTIVATING]:
                                            "Disconnecting...",
                        ...
                        >
                            <box
                                orientation={Gtk.Orientation.VERTICAL}
                                class="margin-top-10 spacing-v-5"
                            >
                                <label
                                    class="margin-left-5"
                                    halign={Gtk.Align.START}
                                ...
                                <entry
                                    ...
                                    onActivate={(self) => {
                                        setShowAuth(false);
                                        execAsync(
                                            `nmcli device wifi connect '${authSsid.get()}' password '${self.get_text()}'`,
                                        ).catch((e) => Logger.error(e));
                                    }}
                                />
                            </box>
...
export default function WifiNetworks() {
        ...
        return (
            <box homogeneous>
                <box
                    orientation={Gtk.Orientation.VERTICAL}
                    valign={Gtk.Align.CENTER}
                    class="txt spacing-v-10"
                >
                    <box
                        orientation={Gtk.Orientation.VERTICAL}
                        class="spacing-v-5 txt-subtext"
                    >
                        <label
    ...
    return (
        <box orientation={Gtk.Orientation.VERTICAL} class="spacing-v-10">
            <box orientation={Gtk.Orientation.VERTICAL} class="spacing-v-5">
                ...
                >
                    <box class="spacing-h-5">
                        <label
                            class="txt icon-material txt-norm"
                            label="wifi"
                        />
                        <label class="txt txt-small" label="WiFi Adapter" />
                        <box hexpand />
                        <box
                            class={wifiEnabled.as(
                                (e: any) =>
                                    `switch-bg ${e ? "switch-bg-true" : ""}`,
                            )}
                            valign={Gtk.Align.CENTER}
            ...
            <stack
                visibleChildName={wifiEnabled.as((e) =>
                    e ? "list" : "disabled",
                )}
