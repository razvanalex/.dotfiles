...
function NotificationPopup({
    ...
    return (
        <revealer
            ...
            $={(self) => {
                const isClosing = closingIds.as((s: Set<number>) =>
                    s.has(notification.id),
                );
            ...
            >
                <box valign={Gtk.Align.START} homogeneous>
                    <overlay>
                        {(() => {
                            if (
                                isScreenshotNotification(notification) &&
                                notification.image
                            ) {
...
export default function NotificationPopups({
    ...
    return (
        <box
            ...
            visible={notifications.as(
                (p: Notifd.Notification[]) => p.length > 0,
            )}
        >
