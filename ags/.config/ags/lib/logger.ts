...
export class Logger {
    ...
    static info(message: any, ...args: any[]): void {
        this._defaultInstance.info(message, ...args);
    }

    static warn(message: any, ...args: any[]): void {
        this._defaultInstance.warn(message, ...args);
    }

    static error(message: any, ...args: any[]): void {
        this._defaultInstance.error(message, ...args);
    }

    static debug(message: any, ...args: any[]): void {
        this._defaultInstance.debug(message, ...args);
    }
